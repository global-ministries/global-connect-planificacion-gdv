/**
 * S20 STUB — niños check-in/out shell.
 ...
 */
export function NinosCheckinShell(props: CaptureUXInput): CaptureUXOutput {
  return {
    state: props.state,
    shape: 'attendance',
    actions: defaultActionsForState(props.state),
    feedback: `[STUB: niños check-in/out shell, state=${props.state}]`,
  }
}
